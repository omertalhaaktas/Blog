...
namespace Blog.Data.Infrastructure
{
    public class EntityBaseData<T> : IData<T> where T : ModelBase
    {
        ...
        public T FirstOrDefault(Expression<Func<T, bool>> predicate, string orderBy, bool isDesc, bool asNoTracking)
        {
            try
            {
                var query = _context.Set<T>().AsQueryable();
        ...
        public List<T> GetAll(string orderBy, bool isDesc)
        {
            return isDesc
        ...
        public List<T> GetBy(Expression<Func<T, bool>> predicate, string orderBy, bool isDesc)
        {
            try
            {
                return isDesc
        ...
        //OrderBy sıralanacak model deki item Id yerine publishdate
